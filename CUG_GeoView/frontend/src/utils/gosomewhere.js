...
function goSpectralIndex() {
    this.isNavigator = false;
    if (this.$route.path === "/spectralindex") {
        this.$message.success('您已经在该界面了哦')
    } else this.$router.push("spectralindex");
}
...
export { goDetectChanges, goDetectObjects, goSegmentation,goClassification,goRestoreImgs,goOnlineMap,goHistory, goSpectralIndex }
